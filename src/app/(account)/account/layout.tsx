    ...
    <AuthUserProvider user={response.data.user}>
      <SidebarProvider>
        ...
        <SidebarInset className="bg-gray-50/50">
          <header className="flex h-16 shrink-0 items-center gap-2 border-b border-gray-100 bg-white shadow-xs transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12">
            ...
            <div className="flex items-center gap-2 px-4">
              <div className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-linear-to-r from-indigo-50 to-violet-50 border border-indigo-100 text-indigo-600 text-xs font-medium">
