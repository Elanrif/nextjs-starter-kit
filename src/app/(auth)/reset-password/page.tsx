        ...
        <div className="flex-1 flex flex-col px-6 py-8 lg:px-12">
          ...
          <div className="flex-1 flex items-center justify-center">
            <div className="w-full max-w-sm">
              <div className="bg-white/5 border border-white/8 rounded-2xl p-8 backdrop-blur-sm text-center">
                ...
                <Link
                  href={ROUTES.FORGOT_PASSWORD}
                  className="inline-flex items-center justify-center gap-2 w-full px-4 py-2.5 rounded-xl bg-linear-to-r from-indigo-600 to-violet-600 hover:from-indigo-500 hover:to-violet-500 text-white text-sm font-semibold shadow-lg shadow-indigo-900/30 transition-all"
                >
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="w-full max-w-sm">
            ...
            <div className="bg-white/5 border border-white/8 rounded-2xl p-6 backdrop-blur-sm">
              {/* Email chip */}
              <div className="flex items-center gap-2.5 px-3 py-2.5 bg-indigo-500/10 border border-indigo-500/20 rounded-xl mb-4">
      ...
      <div className="relative w-full flex flex-col justify-between p-12">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-5 max-w-xs">
          <p className="text-white text-sm leading-relaxed">
            &ldquo;Votre sécurité est notre priorité. Chaque accès est
            protégé.&rdquo;
          </p>
            ...
            <div className="space-y-1.5">
              <div className="flex gap-1">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="flex-1 h-1.5 rounded-full bg-linear-to-r from-indigo-500 to-violet-500"
                  />
                ))}
              </div>
