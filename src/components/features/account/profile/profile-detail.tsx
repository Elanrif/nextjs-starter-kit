    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      >
        ...
        <div>
          ...
          <p
            className={`text-sm font-semibold mt-0.5 ${user.isActive ? "text-emerald-700" : "text-red-700"}`}
          >
      ...
      <div className="flex gap-3">
        ...
        <Link
          href={EDIT_PROFILE}
          className="flex-1 flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-linear-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-white text-sm font-semibold transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5"
        >
