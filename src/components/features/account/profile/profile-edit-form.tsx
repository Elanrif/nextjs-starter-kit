...
/**
 * Reçoit `user` depuis le Server Component (données fraîches via getCurrentUser/JWT).
 * Utilise `setUser` du contexte uniquement pour synchroniser le cache localStorage
