...
REPO_URL="<repository-url>"           # ex: https://github.com/Elanrif/nextjs-starter-kit.git
FOLDER_NAME="<folder-name>"           # ex: nextjs-social-feedback, my-project
```
...
REPO_URL="https://github.com/Elanrif/nextjs-starter-kit.git"
FOLDER_NAME="nextjs-social-feedback"
...
```bash
git clone -b kit/next-auth --single-branch https://github.com/Elanrif/nextjs-starter-kit.git nextjs-social-feedback
cd nextjs-social-feedback
git remote -v
git remote remove origin
npm i
```
...
- `https://github.com/Elanrif/nextjs-starter-kit.git` → par l'URL de ton repository
- `nextjs-social-feedback` → le nom du dossier local où tu veux cloner
